...
const ChatWidget = () => {
  ...
  const widgetContent = (
    <div className="fixed bottom-6 right-6 z-[9000] flex flex-col items-end">
      ...
      {isOpen && (
        <div
          className={`bg-white border border-slate-200/90 rounded-3xl shadow-2xl overflow-hidden flex flex-col transition-all duration-200 ease-out mb-3 w-[calc(100vw-2rem)] sm:w-[380px] ${
      ...
      {!isOpen && (
        <button
          ...
          className="group relative flex items-center gap-2.5 px-4 py-3 bg-gradient-to-r from-indigo-600 via-indigo-700 to-indigo-800 hover:from-indigo-500 hover:to-indigo-600 text-white rounded-full shadow-2xl hover:shadow-indigo-500/40 hover:-translate-y-0.5 transition-all"
        >
